    ...
    <div className="container bg-light">
      <section className="container my-5" style={{ color: "#052046" }}>
        <h1 className="text-center">
          Why Purchase Your Perfect Car From <br /> Our Company
        </h1>
        <hr />
        <p>
          Learn why you should consider a Certified Pre-Owned car, and get info
          on manufacturer programs.
        </p>
      </section>
      <div className="card-group row row-cols-sm-1 row-cols-md-3 g-2">
        ...
        <div className="text-white">
          ...
          >
            ...
            <p className="card-text">
              We give the best return service policies and we try to best. View
              side-by-side comparisons, payment calculators, video reviews, and
              consumer reviews. These let you hear the good and the bad from
              current.
            </p>
          </div>
        </div>
        <div className="text-white">
          ...
          >
            ...
            <p className="card-text">
              Our servicing is very also get joibs good we try to best. Our very
              own Cars.com experts offer unbiased coverage of today's automotive
              landscape. Yes, we have to compes to come out, and consumer
              reviews.
            </p>
          </div>
        </div>
